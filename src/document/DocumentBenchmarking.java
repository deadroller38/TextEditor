	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 *     b. Calls fleshScore on this document */
			 ...
			 Document testBasic = new BasicDocument(testText);
			 double fleshScore = testBasic.getFleschScore();
			 ...
			 *     b. Calls fleshScore on this document*/
			 ...
			 Document testEfficient = new EfficientDocument(testText);
			 fleshScore = testEfficient.getFleschScore();
